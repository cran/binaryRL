...
#'  specified ranges.
#'
#' The last parameter, representing the temperature (`tau`) in the soft-max
#'  function, is drawn from an exponential distribution. If its `upper` bound
#'  is set to 1, it implies `tau` is sampled from `Exp(1)` (an exponential
#'  distribution with a rate parameter of 1). If its `lower` bound is set
#'  to 1, this means that after `tau` is randomly generated, it is shifted
#'  to the right by adding 1 (i.e., `tau + 1`), establishing a minimum value.
#' 
